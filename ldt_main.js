	...
	**/
	...
	function ampExtension(options)
	{
		...
		var ampObj = 
		{
			...
			primeCats :  [
				{a
					nameForFeedback : 'real_word',  //Will be used in the user feedback 
					nameForLogging : 'real word', //Will be used in the logging
					//An array of all media objects for this category.
					mediaArray : [{word : 'Wonderful'}, {word : 'Great'}]
				}, 
				{
					nameForFeedback : 'false_word',  //Will be used in the user feedback 
					nameForLogging : 'false word', //Will be used in the logging
